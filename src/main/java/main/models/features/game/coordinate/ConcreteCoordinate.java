...
public class ConcreteCoordinate implements Coordinate {
    ...
    private static final ClosedInterval<Integer> LIMITS = new ClosedInterval<>(1, main.models.features.game.Coordinate.DIMENSION);
    ...
    public void random() {
        ...
        setRow(random.nextInt(main.models.features.game.Coordinate.DIMENSION));
        setColumn(random.nextInt(main.models.features.game.Coordinate.DIMENSION));
    }
