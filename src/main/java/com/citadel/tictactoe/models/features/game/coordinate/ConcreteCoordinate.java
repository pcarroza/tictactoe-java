...
public class ConcreteCoordinate implements Coordinate {
    ...
    private static final ClosedInterval<Integer> LIMITS = new ClosedInterval<>(1, com.citadel.tictactoe.models.features.game.Coordinate.DIMENSION);
    ...
    public void random() {
        ...
        setRow(random.nextInt(com.citadel.tictactoe.models.features.game.Coordinate.DIMENSION));
        setColumn(random.nextInt(com.citadel.tictactoe.models.features.game.Coordinate.DIMENSION));
    }
